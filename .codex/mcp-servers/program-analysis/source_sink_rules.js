...
const RULES = [
  ...
  },
  {
    lang: "js",
    kind: "sink",
    id: "js.sql.dynamic_query_template",
  ...
  },
  {
    lang: "js",
    kind: "sink",
    id: "js.sql.dynamic_query_concat",
    pattern: /\.(query|execute)\s*\(\s*(["'])(?:(?!\2).)*\2\s*\+/g,
    cwe: "CWE-89",
  },
  ...
  },
  {
    lang: "py",
    kind: "sink",
    id: "py.sql.dynamic_query_fstring",
  ...
  },
  {
    lang: "py",
    kind: "sink",
    id: "py.sql.dynamic_query_format",
  ...
  },
  {
    lang: "py",
    kind: "sink",
    id: "py.sql.dynamic_query_concat",
  ...
  },
  {
    lang: "go",
    kind: "sink",
    id: "go.sql.dynamic_query_sprintf",
    pattern:
      /\b\w+\.(Query|QueryRow|Exec)(Context)?\s*\(\s*(\w+\s*,\s*)?fmt\.Sprintf\s*\(/g,
    cwe: "CWE-89",
  },
  {
    lang: "go",
    kind: "sink",
    id: "go.sql.dynamic_query_concat",
    pattern:
      /\b\w+\.(Query|QueryRow|Exec)(Context)?\s*\(\s*(\w+\s*,\s*)?["'][^"']*["']\s*\+/g,
    cwe: "CWE-89",
  },
