...
const RULES = [
  ...
  },
  {
    lang: "js",
    kind: "sink",
    id: "js.ssrf.http_request",
    pattern:
      /\b(axios\.(get|post|put|delete|patch|request)|fetch|https?\.(get|request))\s*\(/g,
    cwe: "CWE-918",
  },
  ...
  },
  {
    ...
    kind: "sink",
    id: "py.ssrf.requests",
    pattern: /\brequests\.(get|post|put|delete|head|patch|request)\s*\(/g,
    cwe: "CWE-918",
  },
  {
    lang: "py",
  ...
  },
  {
    ...
    pattern: /\bnew\s+URL\s*\([^)]*\)\.openConnection\s*\(/g,
    cwe: "CWE-918",
  },
];
