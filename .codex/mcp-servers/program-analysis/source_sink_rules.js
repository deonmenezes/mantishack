...
const RULES = [
  ...
  },
  {
    ...
    id: "js.sql.query",
    pattern:
      /\b(connection|conn|db|pool|client)\.(query|execute)\s*\(|\bknex\.raw\s*\(/g,
    cwe: "CWE-89",
  },
  ...
  },
  {
    ...
    kind: "sink",
    id: "py.sql.execute",
    pattern: /\b(cursor|conn|connection|session)\.execute\s*\(/g,
    cwe: "CWE-89",
  },
  ...
  },
  {
    ...
    kind: "sink",
    id: "go.sql.query",
    pattern: /\bdb\.(Query|QueryRow|QueryContext|Exec|ExecContext)\s*\(/g,
    cwe: "CWE-89",
  },
