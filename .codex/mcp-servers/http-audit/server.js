...
const { redactionPatterns } = require("../lib/secret_patterns.js");
...
// the findings spine's write-guard (`lib/secret_patterns.js`) so the two
// backstops can't drift out of sync with each other.
const SECRET_VALUE_PATTERNS = redactionPatterns();
