#!/usr/bin/env python3
"""
MANTISHACK DevContainer Dependency Verification Script
...
def check_mantishack_structure() -> Tuple[bool, str]:
    """Check if MANTISHACK directory structure is correct."""
    required_dirs = [
        "packages",
...
def check_mantishack_imports() -> List[TestResult]:
    """Test importing MANTISHACK packages."""
    results = []
...
def run_all_tests(verbose: bool = False, skip_optional: bool = False) -> List[TestResult]:
    ...
    # =========================================================================
    # MANTISHACK STRUCTURE
    # =========================================================================

    passed, msg = check_mantishack_structure()
    results.append(TestResult(
        name="MANTISHACK directory structure",
        category=Category.CORE,
        passed=passed,
        required=True,
        message=msg,
    ...
    results.extend(check_mantishack_imports())
...
def print_results(results: List[TestResult], verbose: bool = False):
    ...
    print("\n" + "=" * 80)
    print(color(" MANTISHACK DevContainer Dependency Verification ", Colors.BOLD + Colors.CYAN))
    print("=" * 80 + "\n")
    ...
    if required_failed > 0:
        ...
        print("  The devcontainer is fully configured for MANTISHACK.\n")
        return True
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Verify MANTISHACK devcontainer dependencies",
