---
name: mantis-status
description: Read Mantis session state, wave status, findings, verification, and grade summaries in Codex.
---
...
- Do not spawn agents.
- Do not inspect Codex session logs. Use `$mantis-debug --deep` for transcript-backed root-cause analysis.
