---
name: mantis-debug
description: Debug Mantis sessions in Codex using MCP telemetry and local session artifacts.
---
...
For local artifact fallback, inspect only file presence/mtimes under `./mantishack-<engagement-id>/[target_domain]` plus Codex session log files needed for `--deep`; do not dump protected raw Mantis artifacts.
