...
# clear this image is internal CI plumbing, not a MANTISHACK distributable.
LABEL org.opencontainers.image.source="https://github.com/gadievron/raptor" \
      org.opencontainers.image.title="mantishack-ci-deps" \
      org.opencontainers.image.description="MANTISHACK INTERNAL CI build-cache image (GitHub Actions unit-test tiers). NOT a MANTISHACK distributable or end-user artifact — do not pull or depend on this image."
