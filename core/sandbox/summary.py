...
the child explicitly re-establishes active-run state. Today's MANTISHACK
...
MANTISHACK_* env var proliferation" feedback, opt-out via env var is not
provided.
"""
...
def _cli_main(argv: Optional[list] = None) -> int:
    ...
    # (libexec/mantishack-sandbox-summary, or `python -m core.sandbox.summary`).
