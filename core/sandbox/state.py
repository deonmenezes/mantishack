...
# User-supplied rlimit overrides from ~/.config/mantishack/sandbox.json.
...
# to restart every MANTISHACK process to pick up the fix. `_FAIL_TTL_S`
...
# fresh MANTISHACK invocation re-probes (handles operator changing their
