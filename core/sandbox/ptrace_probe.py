...
container policy, both static across a single MANTISHACK run.
...
proxy thread or any other coroutine context. In MANTISHACK's lifecycle
...
def _run_probe() -> bool:
    ...
    if pid == 0:
        ...
        try:
            ...
            os.write(2, b"MANTISHACK: ptrace probe child unexpected exception\n")
            os._exit(1)
