"""Direct unit tests for libexec/mantishack-pid1-shim.
...
SHIM_PATH = Path(__file__).resolve().parents[3] / "libexec" / "mantishack-pid1-shim"
...
class TestPid1ShimContract(unittest.TestCase):
    ...
    def test_exec_failure_not_found(self):
        ...
        r = self._run_shim("/nonexistent/mantishack/shim/test/binary")
