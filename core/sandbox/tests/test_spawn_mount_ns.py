...
class TestRunSandboxedSmokeTest(unittest.TestCase):
    ...
    def test_tmp_is_fresh_per_sandbox(self):
        ...
        with tempfile.NamedTemporaryFile(
            dir="/tmp", prefix=".mantishack-canary-", mode="w",
        ) as cf:
    ...
    def test_stub_dir_cleaned_up_after_run(self):
        ...
        empty .mantishack-sbx-* dirs across runs.
        ...
        whole .mantishack-sbx-* prefix globally, which intermittently
        ...
        def recording_mkdtemp(*args, **kwargs):
            ...
            if kwargs.get("prefix", "").startswith(".mantishack-sbx-"):
        ...
        # other .mantishack-sbx-* dirs in /tmp (could be from concurrent
