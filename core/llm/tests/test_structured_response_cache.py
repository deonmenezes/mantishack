...
class _RecordingHandler:
    """Tiny inline log handler. MantishackLogger sets propagate=False on
    its 'mantishack' logger, so pytest's caplog (which hooks the root
    ...
    def __enter__(self):
        ...
        self._lg = logging.getLogger("mantishack")
