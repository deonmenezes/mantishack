"""Adversarial + E2E coverage for ``libexec/mantishack-pick-strategies``.
...
SHIM = REPO_ROOT / "libexec" / "mantishack-pick-strategies"
...
class TestArgparseBoundaries:
    ...
    def test_help_flag(self):
        r = _run("--help")
        assert r.returncode == 0
        assert "mantishack-pick-strategies" in r.stdout
...
class TestSkillIntegration:
    def test_stage_a_references_shim(self):
        ...
        assert "libexec/mantishack-pick-strategies" in text
