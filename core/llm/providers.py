...
class OpenAICompatibleProvider(LLMProvider):
    ...
    def __init__(self, config: ModelConfig):
        ...
        # that case.
        use_dispatcher = (
            os.environ.get("MANTISHACK_LLM_SOCKET")
...
class AnthropicProvider(LLMProvider):
    ...
    def __init__(self, config: ModelConfig):
        ...
        # ``MANTISHACK_LLM_SOCKET`` wins over ``config.api_key`` so the
...
class GeminiProvider(LLMProvider):
    ...
    def client(self):
        ...
        if not hasattr(self._local, 'client'):
            # Phase B: dispatcher-route when ``MANTISHACK_LLM_SOCKET`` set.
...
class ClaudeCodeLLMProvider(LLMProvider):
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        # operator dotfile might set. Use MantishackConfig.get_
        ...
        from core.config import MantishackConfig as _MantishackConfig
        _cc_env = _MantishackConfig.get_safe_env()
