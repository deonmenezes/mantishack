"""Tests for the libexec/mantishack-enrich-flow-trace-ast-view wrapper."""
...
# libexec/mantishack-enrich-flow-trace-ast-view wrapper as a subprocess.
...
WRAPPER = REPO_ROOT / "libexec" / "mantishack-enrich-flow-trace-ast-view"
...
class MantishackEnrichFlowTraceAstViewTests(unittest.TestCase):
