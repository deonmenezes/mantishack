"""
MANTISHACK Progress Counter - Matrix/Hacker Style
...
def last_stage_name() -> Optional[str]:
    ...
    "mantishack-sca: error during osv" beats the un-attributed
    "mantishack-sca: unrecoverable error".
...
class HackerProgressBar:
    ...
    "mantishack-sca: unrecoverable error during osv (...)" instead
