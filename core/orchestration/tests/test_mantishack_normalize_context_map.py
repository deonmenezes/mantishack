"""Tests for the libexec/mantishack-normalize-context-map wrapper."""
...
# Derive from __file__ rather than os.environ["MANTISHACK_DIR"]: it doesn't KeyError
# when the env var is unset, and it correctly resolves to *this* checkout (e.g. a
# git worktree), not whatever MANTISHACK_DIR happens to point at.
REPO_ROOT = Path(__file__).resolve().parents[3]
WRAPPER = REPO_ROOT / "libexec" / "mantishack-normalize-context-map"
...
class MantishackNormalizeContextMapWrapperTests(unittest.TestCase):
