"""Tests for libexec/mantishack-lifecycle-hook."""
...
REPO_ROOT = Path(__file__).resolve().parents[3]  # core/run/tests/ → mantishack/
HOOK_SCRIPT = REPO_ROOT / "libexec" / "mantishack-lifecycle-hook"
