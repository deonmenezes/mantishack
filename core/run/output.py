...
def get_output_dir(command: str, target_name: str = "", explicit_out: str = None,
    ...
    3. Default: MantishackConfig.get_out_dir() with command prefix + timestamp
    ...
    if active:
        ...
        effective_target = target_path or os.environ.get("MANTISHACK_CALLER_DIR")
    ...
    return MantishackConfig.get_out_dir() / dirname
