    ...
    *,
    ...
    Args:
        ...
        indent: Leading whitespace for each line. Default matches
            mantishack_agentic.py's existing report cadence ("   ").
