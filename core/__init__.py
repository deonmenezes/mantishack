...
MantishackConfig` directly, the eager re-exports added 100-300 ms
...
first access only. ``from core import MantishackConfig`` triggers
__getattr__("MantishackConfig"), imports core.config, returns the
...
# with __all__ below.
_LAZY_EXPORTS = {
    "MantishackConfig":               ("core.config",       "MantishackConfig"),
