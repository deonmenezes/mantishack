...
class TestAddDirectory(unittest.TestCase):
    ...
    def test_add_directory_of_runs(self):
        ...
        runs.mkdir()
        for name in ["scan_vulns_20260401", "scan_vulns_20260402", "mantishack_vulns_20260403"]:
            d = runs / name
            d.mkdir()
    ...
    def test_prefix_inference(self):
        ...
        for name, expected_cmd in [
            ...
            ("mantishack_vulns_20260406", "agentic"),
        ...
        runs.mkdir()
        for name in ["scan_vulns_20260406", "mantishack_vulns_20260406", "exploitability-validation-20260406"]:
