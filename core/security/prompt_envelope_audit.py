...
MANTISHACK's canonical defenses:
...
target repo gets text into MANTISHACK's prompt context. Tag-forgery
...
_ALLOWLIST: Tuple[AllowlistEntry, ...] = (
    ...
    AllowlistEntry(
        ...
        audit_note=(
            ...
            'smt_result.reasoning is MANTISHACK-internal SMT output, not '
            'attacker-controlled'
        ),
    ),
    AllowlistEntry(
