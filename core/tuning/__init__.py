...
def _create_default_file(path: Path) -> None:
    ...
    rename) so that:
      * A concurrent reader (libexec/mantishack-tune, get_tuning's
      ...
      * Two concurrent writers (this function + mantishack-tune CLI
    ...
    """
    try:
        # Import here to avoid circular dep with libexec/mantishack-tune
