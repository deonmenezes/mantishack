...
class TestSageClientWithMock(unittest.TestCase):
    ...
    def test_propose_auto_embeds(self):
        ...
        try:
            ...
            self.assertTrue(sc.propose("hello", domain_tag="mantishack-findings"))
