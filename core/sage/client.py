"""
Synchronous SAGE client wrapper for MANTISHACK.
...
MANTISHACK's pipeline is fully synchronous, so this uses sage_sdk.client.SageClient
...
class SageClient:
    ...
    Usage::
        ...
        if client.is_available():
            results = client.query("crash patterns for heap overflow", "mantishack-crashes")
    """
