"""MANTISHACK startup banner — formatting and display.
...
def read_logo() -> str:
    """Read the ASCII logo from the mantishack-offset file."""
    path = _ASSETS / "mantishack-offset"
...
def format_banner(
    ...
    lines.append("")
    lines.append(f"mantishack:~$ {quote}")
