...
def test_render_block_has_oracle_location_and_discipline_line():
    ...
    assert "## MANTISHACK-verified exemplars" in block
...
def test_block_for_finding_collection_path(tmp_path):
    ...
    assert "## MANTISHACK-verified exemplars" in block and "F-1" in block
...
_SHIM = REPO / "libexec" / "mantishack-verified-outcomes"
