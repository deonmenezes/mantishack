...
def _get_or_build_index(
    ...
    *,
    ...
    # mantishack process against the same source tree. Fingerprint folds
...
def _apply_reexport_aliases(idx: _AdjacencyIndex) -> int:
    ...
    for file_record in inv.get("files", []):
        ...
        # ``from core.config import MantishackConfig`` makes
        # ``core.MantishackConfig`` available to callers via ``from core
        # import MantishackConfig``. Walk this file's imports map and
