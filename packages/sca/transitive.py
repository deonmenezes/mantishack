...
def _try_cascade(
    ...
    # whose path looks like ``/tmp/mantishack-sca-cascade-<rand>/...``
...
def _parse_lockfile_bytes(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="mantishack-sca-cascade-") as td:
    ...
    *, parents: Optional[List[str]] = None,
    ...
    Three re-tags happen here:
      ...
      - ``declared_in=host_manifest_path`` — the original
        ...
        lockfile (``/tmp/mantishack-sca-cascade-<rand>/...``), which is
