"""Operator-managed suppression overlay for ``mantishack-sca`` findings.

A project ships ``.mantishack-sca-suppress.yml`` at its root. Every entry is a
...
SUPPRESS_FILENAME = ".mantishack-sca-suppress.yml"
