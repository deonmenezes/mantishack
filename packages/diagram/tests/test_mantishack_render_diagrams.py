"""Tests for the libexec/mantishack-render-diagrams wrapper.
...
# mantishack-render-diagrams wrapper as a subprocess.
...
WRAPPER = REPO_ROOT / "libexec" / "mantishack-render-diagrams"
...
class MantishackRenderDiagramsForceTests(unittest.TestCase):
