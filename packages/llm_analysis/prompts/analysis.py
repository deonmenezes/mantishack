...
def _build_verified_exemplar_block(
    *,
    ...
    """Render MANTISHACK's own prior verified outcomes for this finding.

    Tier-3 retrieval: the nearest previously-confirmed outcomes (witness /
    CodeQL backends) primed as exemplars beside the curated CVE ones — MANTISHACK's
    ...
    *,
    ...
    if verified_block:
        blocks.append(UntrustedBlock(
            ...
            origin="mantishack-verified-outcomes",
        ))
