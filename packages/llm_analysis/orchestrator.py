#!/usr/bin/env python3
"""
MANTISHACK Orchestrator — Phase 4 of the /agentic workflow.
...
def orchestrate(
    ...
    Called from mantishack_agentic.py Phase 4. Dispatches findings for parallel
    ...
    # (`/home/alice/projects/my-target`, `/tmp/mantishack/foo`) and
