...
The MANTISHACK-shipped LocalFlowSource packs at
...
MANTISHACK pack is required — the gap was operator install layout, not
...
# Run MANTISHACK's Tier 1 discovery + invocation
python3 - <<'PY'
