"""Tests for the IRIS dataflow-validation surfacing in mantishack_agentic.

The section builder is a private helper in mantishack_agentic.py. It reads
...
def _load_agentic_module():
    """Import mantishack_agentic without invoking its CLI entry point.
    ...
    spec = importlib.util.spec_from_file_location(
        "mantishack_agentic_for_tests", repo_root / "mantishack_agentic.py",
    )
