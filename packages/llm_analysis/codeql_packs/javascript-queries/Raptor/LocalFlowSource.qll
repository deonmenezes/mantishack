/**
 * Provides MANTISHACK's `LocalFlowSource` for JavaScript / TypeScript —
 ...
 * Mantishack/LocalFlowSource.qll. Adding a category here is the only change
 * needed to widen IRIS Tier 1's source coverage in JS.
 */

import javascript

// Selection kept in sync across the four MANTISHACK LocalFlowSource
// libraries (Python / JS / Java / Go); see python-queries/Mantishack/
