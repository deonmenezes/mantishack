...
- ✅ Integration with MANTISHACK core configuration
...
# MANTISHACK output directory (optional)
export MANTISHACK_OUT_DIR=/custom/output/dir
```

### MantishackConfig Settings
...
## Integration with MANTISHACK

The CodeQL package integrates seamlessly with MANTISHACK's existing workflow:
...
```bash
# Run full MANTISHACK pipeline with CodeQL
...
Part of the MANTISHACK autonomous security testing framework.
