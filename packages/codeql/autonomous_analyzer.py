...
class AutonomousCodeQLAnalyzer:
    ...
    def __init__(
        ...
        # Matched in mantishack_agentic by --allow-unreachable + threaded
    ...
    def _refine_exploit_loop(
        ...
        * The multi-turn analyser is unavailable (operator ran
          ...
          ``mantishack_codeql.py``) — return immediately with the
    ...
    def analyze_finding_autonomous(
        ...
        if self.validator:
            ...
            # wired at ``mantishack_codeql.py:151`` — only the call site
            # was missing.
