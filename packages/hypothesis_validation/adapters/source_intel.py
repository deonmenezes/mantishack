...
query that selects which slice of MANTISHACK's pre-computed
...
Why a separate adapter:
  * Hypothesis-validation flows benefit from MANTISHACK's curated cocci
...
MANTISHACK-shipped, not LLM-generated.
"""
    ...
    def describe(self) -> ToolCapability:
        return ToolCapability(
            ...
            bad_for=[
                ...
                "Author-defined patterns not in MANTISHACK's shipped rules "
