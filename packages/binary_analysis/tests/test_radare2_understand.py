...
class TestBinaryUnderstand(unittest.TestCase):
    ...
    def test_init_raises_for_missing_binary(self, mock_probe):
        ...
        with self.assertRaises(FileNotFoundError):
            BinaryUnderstand(Path("/nonexistent/mantishack_probe_binary"))
...
class TestSandboxWiring(unittest.TestCase):
    ...
    def test_analyse_sets_r2pipe_r2_to_wrapper(self, _mock_logger):
        ...
        at libexec/mantishack-r2-sandboxed. Captured by patching r2pipe to
        ...
        self.assertTrue(
            captured_env["R2PIPE_R2"].endswith("/libexec/mantishack-r2-sandboxed"),
            f"R2PIPE_R2 was {captured_env['R2PIPE_R2']!r}, "
            f"expected to end with /libexec/mantishack-r2-sandboxed",
        )
        ...
        self.assertEqual(captured_env["_MANTISHACK_TRUSTED"], "1")
    ...
    def test_wrapper_path_resolves_correctly(self):
        ...
        radare2_understand matches libexec/mantishack-r2-sandboxed —
