"""Test for the narrow `except` clause in mantishack_agentic._replay_fuzz_crashes.
...
class TestReplayExceptNarrowing(unittest.TestCase):
    ...
    def _run_with_sandbox_raising(self, exc):
        ...
        from mantishack_agentic import _replay_fuzz_crashes
    ...
    def test_attribute_error_propagates(self):
        ...
        doesn't exist" — a real MANTISHACK bug. Must NOT be swallowed."""
