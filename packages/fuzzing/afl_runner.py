...
class AFLRunner:
    ...
    def __init__(
        ...
        # Anchor default output to MantishackConfig.get_out_dir() so
        ...
        # failure modes:
        #   * Operator running MANTISHACK from `~/work/foo/` got
        ...
        # `MantishackConfig.get_out_dir()` resolves to the active
        ...
        if output_dir:
            ...
            self.output_dir = MantishackConfig.get_out_dir() / f"fuzz_{self.binary.stem}"
    ...
    def run_fuzzing(
        ...
        # Start AFL instances
        processes = []
        log_dir = self.output_dir / "mantishack-logs"
        ...
        for job_id in range(parallel_jobs):
            ...
            # MANTISHACK's control — asking the operator to tune them for every
            ...
            # FULL environment including any MANTISHACK-internal vars
            # (MANTISHACK_*, ANTHROPIC_API_KEY, OPENAI_API_KEY,
            ...
            from core.config import MantishackConfig
            afl_env = MantishackConfig.get_safe_env()
