# test/ — sample target code for MANTISHACK to scan

This directory holds **sample vulnerable code that MANTISHACK scans** during
development, ad-hoc testing, and CodeQL/SMT testbench work. It is
intentionally *not* MANTISHACK's own test suite — the project's unit and
...
- MANTISHACK's own pytest tests → `core/<pkg>/tests/` or `packages/<pkg>/tests/`
